...
import 'package:patient_app/successful_signup.dart';

import 'database.dart';
import 'utils.dart';

class VerifyEmailFirstTime extends StatefulWidget {
  const VerifyEmailFirstTime({Key? key}) : super(key: key);

  @override
  State<VerifyEmailFirstTime> createState() => _VerifyEmailFirstTimeState();
}

class _VerifyEmailFirstTimeState extends State<VerifyEmailFirstTime> {
