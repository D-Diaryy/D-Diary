...
class ProfileTabPatient extends StatefulWidget {
  const ProfileTabPatient({Key? key}) : super(key: key);

  @override
  State<ProfileTabPatient> createState() => _ProfileTabPatientState();
}

class _ProfileTabPatientState extends State<ProfileTabPatient> {
            ...
            children: [
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text(
                    'Patient\'s Code: ' + currentUser!.code.toString(),
                    style: TextStyle(
