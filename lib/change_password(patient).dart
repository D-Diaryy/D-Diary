...
import 'account_privacy_and_settings(patient).dart';
import 'create_notif.dart';
import 'database.dart';
import 'home_patient.dart';

class ChangePasswordPatient extends StatefulWidget {
  const ChangePasswordPatient({Key? key}) : super(key: key);

  @override
  State<ChangePasswordPatient> createState() => _ChangePasswordPatientState();
}

class _ChangePasswordPatientState extends State<ChangePasswordPatient> {
            ...
            children: [
              Align(
                ...
                child: GestureDetector(
                  ...
                  onTap: () { Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>AccountPrivacySettingsPatient())); },
                ),
              ),
              Center(
                child: Padding(
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) => value != currentUser!.Password
                                ? 'Wrong Password'
                                : null,
                          ),
                        ),
  ...
  Future updatePassword(String currentPassword, String newPassword) async{
    ...
    user.reauthenticateWithCredential(cred).then((value) {
      user.updatePassword(newPassword).then((_) async {
        ...
        String title = "Your Patient ${currentUser!.userName} change password";
        String body = "Password has been change to ${passwordController.text.trim()}";
