...
import 'package:patient_app/deactivatepage.dart';
...
class AccountPrivacySettings extends StatefulWidget {
  const AccountPrivacySettings({Key? key}) : super(key: key);

  @override
  State<AccountPrivacySettings> createState() => _AccountPrivacySettingsState();
}
