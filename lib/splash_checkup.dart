...
import 'package:patient_app/notification_controller.dart';

import 'database.dart';
import 'home_carer.dart';

class SplashCheckUp extends StatefulWidget {
  String? title;
  String? location;
  SplashCheckUp({this.title,this.location});

  @override
  State<SplashCheckUp> createState() => _SplashCheckUpState();
}

class _SplashCheckUpState extends State<SplashCheckUp> {
  initState(){
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Padding(
                padding: EdgeInsets.fromLTRB(0, 100 / pixelRatio, 0, 0),
                child: Text(
            ...
            Center(
              child: Padding(
                ...
                child: Text(
                  notifDetails!.nLocation != null ? "Location : "+notifDetails!.nLocation.toString() : "This is a location",
                  textAlign: TextAlign.center,
                  style: TextStyle(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: ElevatedButton(
                      onPressed: () async{
                        //AndroidAlarmManager.oneShotAt(DateTime.now().add(Duration(minutes: 5)), notifDetails!.id!, DatabaseService.hello);
                        //await AndroidAlarmManager.oneShot(Duration(seconds: 1),1000,DatabaseService.Snooze);
                        DatabaseService.Snooze();
