...
class SplashPersonal extends StatefulWidget {
  const SplashPersonal({Key? key}) : super(key: key);

  @override
  State<SplashPersonal> createState() => _SplashPersonalState();
}

class _SplashPersonalState extends State<SplashPersonal> {
  initState(){
          ...
          children: [
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Image.asset(
                  'images/PersonalSplash.png',
                  width: 425/pixelRatio,
                ),
              ),
            ),
            Center(
