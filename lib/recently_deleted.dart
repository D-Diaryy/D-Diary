          ...
          if(retDoc['type'] == ".mp4"){
            return GestureDetector(
              ...
              onTap: (){
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ImageView2(category: "video",doc:retDoc)));
              },
            );
            ...
            return GestureDetector(
              ...
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ImageView2(category: "audio",doc:retDoc)));
              } ,
            );
          }else{
            return GestureDetector(
                ...
                onTap:()async{
                  await DatabaseService(uid: '').getPhotoDataCarerTrash(retDoc.id);
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ImageView2(category: "image",doc: retDoc,)));
                }
            );
          }
      ...
      body: Column(
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('users').doc(currentPatient!.userID).collection('trashBin').snapshots(),
