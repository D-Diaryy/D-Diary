...
class ChangeUsernamePatient extends StatefulWidget {
  const ChangeUsernamePatient({Key? key}) : super(key: key);

  @override
  State<ChangeUsernamePatient> createState() => _ChangeUsernamePatientState();
}

class _ChangeUsernamePatientState extends State<ChangeUsernamePatient> {
